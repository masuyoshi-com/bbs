 ...
 * ナンバーフォーマット
 * 
 * @param string $number_data
 * @return string
 */
 function nf($number_data)
 {
     return ($number_data) ? number_format($number_data) : '-';
 }

 /**
 * 文字省略
 * 
 * @param string $string ストリング型データ
 * @param int $end 最大文字列数を設定
 */
 function strim($string, $end)
 {
     return mb_strimwidth($string, 0, $end, "...", 'utf8');
 }
